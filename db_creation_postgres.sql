...
INSERT INTO time_slots (s_start, s_end) VALUES ('9:00', '9:30'),
                                               ('9:30', '10:00'),
                                               ('10:00', '10:30'),
                                               ('10:30', '11:00'),
                                               ('11:00', '11:30'),
...
CREATE TYPE weekday_t AS enum('monday',
  'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday');

CREATE TYPE meal_type_t AS enum ('breakfast', 'lunch', 'dinner', 'supper');

CREATE TABLE menus (
  id SERIAL PRIMARY KEY,
  weekday weekday_t NOT NULL,
